...
if osystem == "Windows":
    path_ch03 = re.sub('Band05\\\\OR_ABI-L2-CMIPF*(.*)', '', path_ch05)
else:
    path_ch03 = re.sub('Band05/OR_ABI-L2-CMIPF*(.*)', '', path_ch05)
...
"title_text": "GOES-" + satellite[1:3] + " DLC RGB ", "title_size": int(data_ch05.shape[1] * 0.005), "title_x_offset": int(data_ch05.shape[1] * 0.01), "title_y_offset": data_ch05.shape[0] - int(data_ch05.shape[0] * 0.016), 
