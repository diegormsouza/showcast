...
"title_text": "GOES-" + satellite[1:3] + " DWV RGB ", "title_size": int(data_ch10.shape[1] * 0.005), "title_x_offset": int(data_ch10.shape[1] * 0.01), "title_y_offset": data_ch10.shape[0] - int(data_ch10.shape[0] * 0.016), 
...
my_legend = plt.imread(main_dir + '//Legends//DWV_legend.png')
