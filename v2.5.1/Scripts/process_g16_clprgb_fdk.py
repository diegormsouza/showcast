...
# Satellite height
sat_h = file_ch05.variables['goes_imager_projection'].perspective_point_height
# Satellite longitude
sat_lon = file_ch05.variables['goes_imager_projection'].longitude_of_projection_origin
# Satellite sweep
sat_sweep = file_ch05.variables['goes_imager_projection'].sweep_angle_axis
# Read the resolution
band_resolution_km = getattr(file_ch05, 'spatial_resolution')
band_resolution_km = float(band_resolution_km[:band_resolution_km.find("km")])
# Division factor to reduce image size
...
X = file_ch05.variables['x'][:][::f] * sat_h
Y = file_ch05.variables['y'][:][::f] * sat_h
...
"dpi": 150, 
"states_color": 'white', "states_width": data_ch05.shape[0] * 0.00006, 
