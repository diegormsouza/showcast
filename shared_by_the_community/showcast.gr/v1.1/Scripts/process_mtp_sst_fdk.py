...
# Create the mosaic ===========================================================
gdal.BuildVRT(out_dir + 'MTP_SST_STR_' + date + '.vrt', sorted(glob.glob(out_dir + satellite + "_" + storage + "_" + date_month +'*.tif'), key=os.path.getmtime), srcNodata = -32768)
gdal.Translate(out_dir + 'MTP_SST_STR_' + date + '.tif', out_dir + 'MTP_SST_STR_' + date + '.vrt')
print('Generated GeoTIFF: ', 'MTP_SST_STR_' + date + '.tif')
os.remove(out_dir + 'MTP_SST_STR_' + date + '.vrt')
# Export the result to GeoTIFF ================================================

# Read the mosaic
mosaic = gdal.Open(out_dir + 'MTP_SST_STR_' + date + '.tif')
...
"file_name_id_1": "MTP",  "file_name_id_2": product + "_FDK"
}
...
#thumb_dir = out_dir + satellite + "_" + product + '_' + 'thumbnail.png'
