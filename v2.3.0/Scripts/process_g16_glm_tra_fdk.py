...
if (seconds == '00'):
    ...
    if (int(minutes) % acum_minutes == 0):
        ...
        "title_text": "GOES-16 GLM (Tracking) + BAND-13", "title_size": int(data.shape[1] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
        ...
        img3a = ax.plot(e3_lons,e3_lats, 'o', markersize=1.0, color='#fbc28b', markerfacecolor='#fbc28b', alpha = 0.25, transform=ccrs.PlateCarree(), zorder=5)
        img3b = ax.plot(g3_lons,g3_lats, 'o', markersize=1.0, color='#ed6148', markerfacecolor='#ed6148', alpha = 0.50, transform=ccrs.PlateCarree(), zorder=6)
        ...
        # Plot the accumulated flashes, groups and events
        img2a = ax.plot(e2_lons,e2_lats, 'o', markersize=1.0, color='#018fb7', markerfacecolor='#018fb7', alpha = 0.25, transform=ccrs.PlateCarree(), zorder=9)
        img2b = ax.plot(g2_lons,g2_lats, 'o', markersize=1.0, color='#00baa2', markerfacecolor='#00baa2', alpha = 0.50, transform=ccrs.PlateCarree(), zorder=10)
        ...
        # Plot the accumulated flashes, groups and events
        img1a = ax.plot(e1_lons,e1_lats, 'o', markersize=1.0, color='#fffb8a', markerfacecolor='#fffb8a', alpha = 0.25, transform=ccrs.PlateCarree(), zorder=13)
        img1b = ax.plot(g1_lons,g1_lats, 'o', markersize=1.0, color='#fffdc7', markerfacecolor='#fffdc7', alpha = 0.50, transform=ccrs.PlateCarree(), zorder=14)
