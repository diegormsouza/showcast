...
if (product == "ARMRGB_SEC"):
    ...
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "DCPRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//DAYCLOUDPHASE_legend.png')
    newax = fig.add_axes([0.60, 0.60, 0.39, 0.39], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "DLCRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//DAYLANDCLOUD_legend.png')
    newax = fig.add_axes([0.60, 0.60, 0.39, 0.39], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "DMPRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//DAYMICROPHYSICS_legend.png')
    newax = fig.add_axes([0.55, 0.55, 0.44, 0.44], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "DSTRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//DUST_legend.png')
    newax = fig.add_axes([0.55, 0.55, 0.44, 0.44], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "NMPRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//NIGHTMICROPHYSICS_legend.png')
    newax = fig.add_axes([0.55, 0.55, 0.44, 0.44], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
elif (product == "NTCRGB_SEC"):
    my_legend = plt.imread(main_dir + '//Legends//NATURALTRUECOLOR_legend.png')
    newax = fig.add_axes([0.60, 0.60, 0.39, 0.39], anchor='NE', zorder=13) #  [left, bottom, width, height]. All quantities are in fractions of figure width and height.
    newax.imshow(my_legend)
    newax.axis('off')
