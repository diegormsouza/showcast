...
if [ -d "$parentdir/Miniconda3/envs/showcast" ]; then
	...
	echo $parentdir/Miniconda3/envs/showcast/bin/python $parentdir/Cloud/Scripts/pda_aws_download_config.py
	$parentdir/Miniconda3/envs/showcast/bin/python $parentdir/Cloud/Scripts/pda_aws_download_config.py
	echo
