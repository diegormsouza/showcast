...
#data[np.logical_and(data < 0.2, data > -0.2)] = 0
...
# Configuration 
colors = ["#57004d", "#730069", "#910087", "#2c0699", "#4d32af", "#6b5ac3", "#0004a4", "#0014c0", "#0024dc", "#0043ff", "#005fff", "#007bff", "#00a5ff", "#00e1ff", "#ffffff", "#ffffff", "#ffffff", "#f3f000", "#ffd200", "#f0be00", "#f0aa00", "#f09600", "#fd7800", "#f56400", "#ef5500", "#fb3000", "#eb1800", "#db0000", "#a02000", "#8a0f00", "#7d0400"]
...
vmax = 5.0
thick_interval = 0.5
prod_title = 'NOAA Coral Reef Watch Daily 5km SST Anomalies'
satellite = 'MUL'
product = 'SSTANO'
...
"dpi": 150, 
"states_color": 'white', "states_width": sizey * factor * 0.00006, 
"countries_color": 'gold', "countries_width": sizey * factor * 0.00012,
"continents_color": 'gold', "continents_width": sizey * factor * 0.00025,
...
cb.set_label(label='Sea Surface Temperature Anomalies (°C)', color='gray', size=plot_config["title_size"], weight='bold')
