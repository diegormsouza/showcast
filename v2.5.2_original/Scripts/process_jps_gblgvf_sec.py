...
thick_interval = 0.05
prod_title = 'JPSS VIIRS Green Vegetation Fraction Weekly Composite 4km'
satellite = 'JPS'
product = 'GBLGVF'
...
"dpi": 150, 
"states_color": 'gold', "states_width": sizey * factor * 0.00006, 
...
cb.set_label(label='Green Vegetation Fraction (GVF)', color='black', size=plot_config["title_size"], weight='bold')
