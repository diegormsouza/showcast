...
def procDsif(variable,product):
    ...
    "title_text": "GOES-19 " + prod_name + " " + variable, "title_size": int(data.shape[0] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
