...
# Image path
path = (sys.argv[1])
#path = ("..//Samples//OR_ABI-L2-RSRF-M6_G16_s20192931500346_e20192931510054_c20192931531165.nc")
#file = Dataset("..//Samples//OR_ABI-L2-RSRF-M6_G16_s20192931500346_e20192931510054_c20192931531165.nc")
#file = Dataset("..//Samples//OR_ABI-L2-DSRF-M6_G16_s20192931500346_e20192931510054_c20192931519395.nc")
...
"thick_interval": thick_interval, "cbar_labelsize": int(sizey * 0.005), "cbar_labelpad": -int(sizey * 0.0085),
...
proj = ccrs.PlateCarree(central_longitude=longitude)
geos = ccrs.Geostationary(central_longitude=-75.0, satellite_height=35786023.0)
