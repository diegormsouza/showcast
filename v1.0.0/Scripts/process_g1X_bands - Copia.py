...
# Image path
path = ("..//Samples//OR_ABI-L2-CMIPF-M6C02_G16_s20193060830214_e20193060839522_c20193060840005.nc")
...
x = file.variables['x'][min_lon_idx:max_lon_idx][::f] * H 
y = file.variables['y'][min_lat_idx:max_lat_idx][::f] * H 
...
data = file.variables['CMI'][min_lat_idx:max_lat_idx,min_lon_idx:max_lon_idx][::f ,::f ]
#---------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------
...
"resolution": band_resolution_km, 
"dpi": 150, 
"states_color": 'white', "states_width": data.shape[0] * 0.00012, 
"countries_color": 'turquoise', "countries_width": data.shape[0] * 0.00024,
"continents_color": 'cyan', "continents_width": data.shape[0] * 0.00050,
...
"thick_interval": thick_interval, "cbar_labelsize": int(data.shape[0] * 0.005), "cbar_labelpad": -int(8),
...
# Add a title
plt.annotate(plot_config["title_text"] + " " + date_formated , xy=(10, 20), xycoords='figure pixels', fontsize=plot_config["title_size"], fontweight='bold', color='white', bbox=dict(boxstyle="round",fc=(0.0, 0.0, 0.0), ec=(1., 1., 1.)), zorder=6)
