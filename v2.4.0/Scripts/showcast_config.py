...
g16_b01rgb_fdk_config     = '_B01'                                                    # Configuration string
g16_b01rgb_fdk_script     = showcast_dir + '//Scripts//process_g16_b01_rgb_fdk.py'    # Script to activate
g16_b01rgb_fdk_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_b01rgb_sec_config     = '_BS1'                                                    # Configuration string
g16_b01rgb_sec_script     = showcast_dir + '//Scripts//process_g16_b01_rgb_sec.py'    # Script to activate
g16_b01rgb_sec_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_b03rgb_fdk_config     = '_B03'                                                    # Configuration string
g16_b03rgb_fdk_script     = showcast_dir + '//Scripts//process_g16_b03_b05_rgb_fdk.py'# Script to activate
g16_b03rgb_fdk_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_b03rgb_sec_config     = '_BS3'                                                    # Configuration string
g16_b03rgb_sec_script     = showcast_dir + '//Scripts//process_g16_b03_b05_rgb_sec.py'# Script to activate
g16_b03rgb_sec_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_b06rgb_fdk_config     = '_B06'                                                    # Configuration string
g16_b06rgb_fdk_script     = showcast_dir + '//Scripts//process_g16_b06_rgb_fdk.py'    # Script to activate
g16_b06rgb_fdk_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_b06rgb_sec_config     = '_BS6'                                                    # Configuration string
g16_b06rgb_sec_script     = showcast_dir + '//Scripts//process_g16_b06_rgb_sec.py'    # Script to activate
g16_b06rgb_sec_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_armrgb_fdk_config     = ''                                                        # Configuration string
...
g16_armrgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_clprgb_fdk_config     = ''                                                        # Configuration string
...
g16_clprgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_dlcrgb_fdk_config     = ''                                                        # Configuration string
...
g16_dlcrgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_dmprgb_fdk_config     = ''                                                        # Configuration string
...
g16_dmprgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_dstrgb_fdk_config     = ''                                                        # Configuration string
...
g16_dstrgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_ntcrgb_fdk_config     = ''                                                        # Configuration string
...
g16_ntcrgb_sec_config     = '_SEC'                                                    # Configuration string
...
g16_vaafpr_fdk_config     = ''                                                        # Configuration string
g16_vaafpr_fdk_script     = showcast_dir + '//Scripts//process_g16_vaaf_fdk.py'       # Script to activate
g16_vaafpr_fdk_output     = showcast_dir + '//Output//'                               # Output folder
...
g16_vaafpr_sec_config     = '_SEC'                                                    # Configuration string
g16_vaafpr_sec_script     = showcast_dir + '//Scripts//process_g16_vaaf_sec.py'       # Script to activate
g16_vaafpr_sec_output     = showcast_dir + '//Output//'                               # Output folder
...
jps_dnband_sec_config     = ''                                                        # Configuration string
jps_dnband_sec_script     = showcast_dir + '//Scripts//process_jps_bands.py'          # Script to activate
jps_dnband_sec_output     = showcast_dir + '//Output//'                               # Output folder
...
def procProduct(prod_dir, identifier, config, script, min_lon, min_lat, max_lon, max_lat, resolution, output, vis_dir):
    ...
    for filename in sorted(glob.glob(prod_dir+identifier)):
        ...
        or (identifier == 'd6.gif') or (identifier == 'crb3_east.gif'):
            ...
            gnc_files.append(filename + config + '_c' + mtime)
        else: # If the files have unique names 
            gnc_files.append(filename + config)
    ...
    # If a file is not on the log, process it
      if x not in log:
          ...
          os.system(script + ' "' + str(x) + '" ' + str(min_lon) + ' ' + str(min_lat) + ' ' + str(max_lon) + ' ' + str(max_lat) + ' ' + str(resolution) + ' ' + output + ' ' + vis_dir)
          print('\n')  
...
for product in products: # Loop through products 
    ...
    if (globals()[product] == True) and (globals()[product + "_process"] == showcast_process):
        procProduct(directory, identifier, config, script, extent[0], extent[1], extent[2], extent[3], resolution, output, vis_dir)
