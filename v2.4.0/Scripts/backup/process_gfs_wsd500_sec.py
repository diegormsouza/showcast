...
# Add a title
plt.title("GFS (0.5°): Wind Sp. (kt) & Dir. (500 hPa)", fontweight='bold', fontsize=10, loc='left')
...
# Save the image
plt.savefig('GFS' + '_WSD500_' + str(init)[:-9].replace('-', '') + str(hour).zfill(2) + 'Z_' + str(ftime).zfill(3) + '.png', bbox_inches='tight', pad_inches=0)
