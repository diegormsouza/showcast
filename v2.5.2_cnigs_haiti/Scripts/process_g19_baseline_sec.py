...
"title_text": "GOES-19 " + prod_name, "title_size": int(data.shape[1] * factor * 0.005), "title_x_offset": int(data.shape[1] * factor * 0.01), "title_y_offset": data.shape[0] * factor - int(data.shape[0] * factor * 0.016), 
