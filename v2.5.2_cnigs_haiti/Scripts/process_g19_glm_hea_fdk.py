...
if (seconds == '00'):
    ...
    if (int(minutes) % acum_minutes == 0):
        ...
        "title_text": "GOES-19 GLM (Heatmap) + BAND-13", "title_size": int(data.shape[1] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
