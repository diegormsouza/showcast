...
if osystem == "Windows":
    path_ch13 = re.sub('Band07\\\\OR_ABI-L2-CMIPF*(.*)', '', path_ch07)
else:
    path_ch13 = re.sub('Band07/OR_ABI-L2-CMIPF*(.*)', '', path_ch07)
...
osystem = platform.system()
if osystem == "Windows":
    path_ch03 = re.sub('Band07\\\\OR_ABI-L2-CMIPF*(.*)', '', path_ch07)
else:
    path_ch03 = re.sub('Band07/OR_ABI-L2-CMIPF*(.*)', '', path_ch07)
...
"title_text": "GOES-" + satellite[1:3] + " DMP RGB ", "title_size": int(data_ch07.shape[1] * 0.005), "title_x_offset": int(data_ch07.shape[1] * 0.01), "title_y_offset": data_ch07.shape[0] - int(data_ch07.shape[0] * 0.016), 
