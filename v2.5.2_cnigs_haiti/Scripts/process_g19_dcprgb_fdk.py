...
"title_text": "GOES-" + satellite[1:3] + " SWV RGB ", "title_size": int(data_ch13.shape[1] * 0.005), "title_x_offset": int(data_ch13.shape[1] * 0.01), "title_y_offset": data_ch13.shape[0] - int(data_ch13.shape[0] * 0.016), 
