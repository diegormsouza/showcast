...
lat = np.linspace(extent[3], extent[1], data_ch06.shape[0])
lon = np.linspace(extent[0], extent[2], data_ch06.shape[1])
xx,yy = np.meshgrid(lon,lat)
lons = xx.reshape(data_ch06.shape[0], data_ch06.shape[1])
lats = yy.reshape(data_ch06.shape[0], data_ch06.shape[1])
...
"dpi": 150, 
"states_color": 'white', "states_width": data_ch06.shape[0] * 0.00018, 
...
my_legend = plt.imread(main_dir + '//Legends//DAYLANDCLOUDFIRE_legend.png')
