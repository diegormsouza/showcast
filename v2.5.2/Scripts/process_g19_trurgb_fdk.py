...
data_ch01 = file_ch01.variables['CMI'][:,:][::f ,::f ]
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Read the image
...
# Satellite longitude
sat_lon = file_ch01.variables['goes_imager_projection'].longitude_of_projection_origin
# Satellite sweep
sat_sweep = file_ch01.variables['goes_imager_projection'].sweep_angle_axis
# Read the resolution
band_resolution_km = getattr(file_ch01, 'spatial_resolution')
band_resolution_km = float(band_resolution_km[:band_resolution_km.find("km")])
# Division factor to reduce image size
...
X = file_ch01.variables['x'][:][::f] * sat_h
Y = file_ch01.variables['y'][:][::f] * sat_h
...
rayleigh_key = ('GOES-19','abi', atmosphere, aerosol_type)
corrector = Rayleigh('GOES-19', 'abi', atmosphere=atmosphere, aerosol_type=aerosol_type)
...
"dpi": 150, 
"states_color": 'white', "states_width": data_ch01.shape[0] * 0.00006, 
"countries_color": 'white', "countries_width": data_ch01.shape[0] * 0.00012,
...
"title_text": "GOES-" + satellite[1:3] + " TRU RGB ", "title_size": int(data_ch01.shape[1] * 0.005), "title_x_offset": int(data_ch01.shape[1] * 0.01), "title_y_offset": data_ch01.shape[0] - int(data_ch01.shape[0] * 0.016), 
