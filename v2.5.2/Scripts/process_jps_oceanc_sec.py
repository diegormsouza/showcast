...
# Configuration 
colors = ["#84007c", "#1d00e1", "#0066ff", "#00ffe7", "#00ff00", "#ffff00", "#ff8a00", "#ff0000", "#bb0000", "#b46464"]
...
vmax = 65.00
thick_interval = 1.0
prod_title = 'NOAA-20 - VIIRS Chlorophyll Concentration (Chl-a)'
satellite = 'JPS'
product = 'OCRG' + region
...
img = ax.imshow(data, vmin=plot_config["vmin"], vmax=plot_config["vmax"], norm=norm, origin='upper', extent=img_extent, cmap=plot_config["cmap"], zorder=3)
...
cb.set_label(label='Chlorophyll-a (mg/m³)', color='lightgray', size=plot_config["title_size"], weight='bold')
