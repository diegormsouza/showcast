...
"countries_color": 'white', "countries_width": sizey * factor * 0.00012,
"continents_color": 'white', "continents_width": sizey * factor * 0.00025,
"grid_color": 'white', "grid_width": sizey * factor * 0.00025, "grid_interval": 10.0,
"vmin": vmin, "vmax": vmax, "cmap": cmap,
"title_text": "METOP " + prod_title + " ", "title_size": int(sizex * factor * 2 * 0.0025), "title_x_offset": int(sizex * factor * 0.01), "title_y_offset": sizey * factor - int(sizey * factor * 0.016),
"thick_interval": 1, "cbar_labelsize": int(sizey * factor * 0.005), "cbar_labelpad": -int(sizey * factor * 0.0),
...
cb.set_label(label='Sea Surface Temperature (°C)', color='black', size=plot_config["title_size"], weight='bold')
