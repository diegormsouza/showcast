...
if ("ABI" in file_name): 
	prod_name = "GOES-19 ABI Hourly Composite"
	product = "ABIHLY"
...
if (prod_name == "GOES-19 ABI Hourly Composite"):
...
"countries_color": 'black', "countries_width": data.shape[0] * 0.00024,
...
# Save the image
fig.savefig(out_dir + plot_config["file_name_id_1"] + "_" + plot_config["file_name_id_2"] + "_" + date_file + '.png', facecolor='black')
