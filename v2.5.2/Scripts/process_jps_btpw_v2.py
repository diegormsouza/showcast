...
"countries_color": 'black', "countries_width": data.shape[0] * factor * 0.00036,
"continents_color": 'black', "continents_width": data.shape[0] * factor * 0.00050,
"grid_color": 'white', "grid_width": data.shape[0] * factor * 0.00025, "grid_interval": 10.0,
"vmin": vmin, "vmax": vmax, "cmap": cmap,
"title_text": "Multimission " + prod_title + " ", "title_size": int(data.shape[1] * factor * 2 * 0.0025), "title_x_offset": int(data.shape[1] * factor * 0.01), "title_y_offset": data.shape[0] * factor - int(data.shape[0] * factor * 0.032), 
"thick_interval": thick_interval, "cbar_labelsize": int(data.shape[1] * factor * 0.005), "cbar_labelpad": -int(data.shape[1] * factor * 0.0),
...
cb.set_label(label=prod_title, color='black', size=plot_config["title_size"] , weight='bold')
