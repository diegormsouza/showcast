...
"title_text": "GOES-19 GLM + BAND-13", "title_size": int(data.shape[1] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[1] - int(data.shape[1] * 0.016), 
