...
# Configuration 
colors = ["#640064", "#6300f9", "#2259d3", "#0078ff", "#00bdfe", "#00ffff", "#0ba062", "#ffff00", "#ffbe00", "#ff5000", "#db0000", "#950000", "#640000"]
...
vmax = 3.0
thick_interval = 0.5
prod_title = 'NOAA Coral Reef Watch Daily 5km SST Trend (Past 7 Days)'
satellite = 'MUL'
product = 'SSTTRE'
...
cb.set_label(label='SST Trend - Past 7 Days (°C/Week)', color='gray', size=plot_config["title_size"], weight='bold')
