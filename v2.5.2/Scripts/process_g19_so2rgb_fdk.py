...
data_ch09 = file_ch09.variables['CMI'][:,:][::f ,::f ] - 273.15
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Read the image
...
# Read the resolution
band_resolution_km = getattr(file_ch10, 'spatial_resolution')
band_resolution_km = float(band_resolution_km[:band_resolution_km.find("km")])
...
# Get the pixel values
data_ch10 = file_ch10.variables['CMI'][:,:][::f ,::f ] - 273.15
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Read the image
...
# Read the resolution
band_resolution_km = getattr(file_ch11, 'spatial_resolution')
band_resolution_km = float(band_resolution_km[:band_resolution_km.find("km")])
...
# Get the pixel values
data_ch11 = file_ch11.variables['CMI'][:,:][::f ,::f ] - 273.15
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# RGB Components
...
"dpi": 150, 
"states_color": 'white', "states_width": data_ch09.shape[0] * 0.00006, 
