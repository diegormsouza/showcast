...
if (inside == True):
    ...
    date = Start[0:12]
    grid = driver.Create('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date, ncols, nlines, 1, data_type)#, options)
    ...
    dst_ds = driver.CreateCopy('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date + '.tif', grid, 0) 
    ...
    grid = None
    # Delete the grid
    os.remove('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band  + '_' + date)     
    #print("Processing finished.")

    date_day = date[0:8] # this option takes lots of disk space! But it is possible
	
    # Create the mosaic ===========================================================
    gdal.BuildVRT('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt', sorted(glob.glob('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date_day +'*.tif'), key=os.path.getmtime), srcNodata = -10)
    gdal.Translate('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band[0:4] + 'HA_' + date + '.tif', '..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt')
    print('Generated GeoTIFF: ', 'JPS_' + band[0:4] + 'HA_' + date + '.tif')
    os.remove('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt')
    # Export the result to GeoTIFF ================================================
    ...
    mosaic = gdal.Open('..//Output//' + satellite + '//' + product + '//' + 'JPS_' + band[0:4] + 'HA_' + date + '.tif')
