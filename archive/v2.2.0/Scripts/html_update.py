...
#---------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------
def update(satellite, product, nfiles):
    ...
    out_dir = main_dir + '//HTML//Output//' + satellite
	
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)

    # Create the product output directory if it doesn't exist
    out_dir = main_dir + '//HTML//Output//' + satellite + '//' + product + '//'
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)
    ...
    # Directory
    directory = main_dir + '//Output//' + satellite + '//' + product + '//'
    ...
    thumb_dir = main_dir + '//HTML//Output//QuickLooks//' + rename_id + 'quicklook.png'
    copyfile(files[-1], dst)
