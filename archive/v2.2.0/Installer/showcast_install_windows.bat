...
IF EXIST %ParentFolderName%\Miniconda3\envs\showcast\ (
	...
	echo:
	call %ParentFolderName%\Miniconda3\condabin\conda create --name showcast -c conda-forge affine cartopy folium gdal geopandas glymur matplotlib netcdf4 pandas Pillow pygrib pyhdf pyorbital pyproj pyresample rasterstats satpy siphon --yes
)
