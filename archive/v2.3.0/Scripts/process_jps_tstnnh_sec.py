...
# Image path
path_toast = (sys.argv[1])[:-4]

# Open the GRIB file
grib = pygrib.open(path_toast)
...
"dpi": 150, 
"states_color": 'white', "states_width": 2712 * 0.00006, 
"countries_color": 'white', "countries_width": 2712 * 0.00012,
"continents_color": 'white', "continents_width": 2712 * 0.00025,
"grid_color": 'white', "grid_width": 2712 * 0.00025, "grid_interval": 10.0,
"vmin": vmin, "vmax": vmax, "cmap": cmap,
"title_text": "Blended TOAST - SNPP OMPS & NOAA-20 CrIS Daily Total Ozone (Northern Hemisphere)", "title_size": int(2712 * 0.004), "title_x_offset": int(2712 * 0.01), "title_y_offset": 2712 - int(2712 * 0.016), 
"thick_interval": thick_interval, "cbar_labelsize": int(2712 * 0.005), "cbar_labelpad": -int(2712 * 0.00),
...
# Save the image
plt.savefig(out_dir + satellite + '_' + product + '_' + date + '.png', facecolor='black')
