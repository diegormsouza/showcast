...
def procDsif(variable,product):
    ...
    "title_text": "GOES-16 " + prod_name + " " + variable, "title_size": int(data.shape[0] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[0] - int(data.shape[0] * 0.016), 
...
# Image path
path = (sys.argv[1])
#path = ("..//Samples//OR_ABI-L2-DSIF-M6_G16_s20192671310233_e20192671319541_c20192671321226.nc")
