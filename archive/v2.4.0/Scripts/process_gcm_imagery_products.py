...
def procGcom(product, start, lat_file, lon_file, var_file, width, height):
   ...
   gdal.Translate((sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_image.vrt', connectionInfo, format='VRT')
 
   # Read latitude dataset
   connectionInfo = 'HDF5:\"' + path + '\"://' + variable_lat
   #print(connectionInfo)
   gdal.Translate((sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_lat.vrt', connectionInfo, format='VRT')

   # Read longitude dataset
   connectionInfo = 'HDF5:\"' + path + '\"://' + variable_lon
   #print(connectionInfo)
   gdal.Translate((sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_lon.vrt', connectionInfo, format='VRT')

   # Make the necessary change to the VRT file (the same for any GCOM product)
   readFile = open( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_image.vrt')
   lines = readFile.readlines()
   readFile.close()
   w = open( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_image.vrt','w')
   w.writelines([item for item in lines[:-1]])
   w.write("<Metadata domain=\"GEOLOCATION\">" + '\n')
   w.write("<MDI key=\"X_DATASET\">" +  (sys.argv[7]) + satellite + '//' + storage  + '//' + 'GCM_' + product + '_' + start + '_lon.vrt' + "</MDI>" + '\n')
   w.write("<MDI key=\"X_BAND\">1</MDI>" + '\n')
   w.write("<MDI key=\"Y_DATASET\">" +  (sys.argv[7]) + satellite + '//' + storage  + '//' + 'GCM_' + product + '_' + start + '_lat.vrt' + "</MDI>" + '\n')
   ...
   # Create the GeoTIFF
   grid = gdal.Warp( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_image.vrt', format = 'GTiff', outputType = gdal.GDT_Float32, outputBounds = extent, geoloc = True, srcNodata=-9999, width = width, height = height)
   ...
   os.remove( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_image.vrt')
   os.remove( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_lat.vrt')
   os.remove( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '_lon.vrt')
   
   #print("Opening GeoTIFF:")
   # Read the created GeoTIFF to check if it has valid pixels
   geotiff = gdal.Open( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif')
       ...
       if orbit == "None":
           try:
               ...
               if result > 0:
                   ...
                   orbit_title = "(Descending Pass)"
                   orbit = "D"	
                   move( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + 'D_' + start + '.tif')
                   orbit = "D"                   
                   ...
                   orbit_title = "(Ascending Pass)"
                   orbit = "A"		   
                   move( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + 'A_' + start + '.tif')
                   orbit = "A"
                   product = product + orbit
                   ...
                   if result > 0:
                       ...
                       #print("GIVE UP!") 
                       orbit_title = "(Unknown)"
                       move( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + 'E_' + start + '.tif')
                       orbit = "E"                       
                       product = product + orbit
            ...
            move( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + orbit + '_' + start + '.tif')
            product = product + orbit
   ...
   try:
       ...
       geotiff = None 
       os.remove( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.tif.aux.xml')
       if (product != "SEAICN" and product != "SEAICS"):
	      # Generates the daily mosaic
          start_day = start[0:8]
          gdal.BuildVRT( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.vrt', sorted(glob.glob( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start_day + '*.tif'), key=os.path.getmtime), srcNodata = -9999)
          gdal.Translate( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product[2:6] + 'DA_' + start + '.tif',  (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.vrt', outputType = gdal.GDT_Float32, width = width, height = height)        
          print('Generated GeoTIFF: ','GCM_' + product[2:6] + 'DA_' + start + '.tif')  
          os.remove( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product + '_' + start + '.vrt')
          
          # Check if there is valid pixels in the region of interest
          mosaic = gdal.Open( (sys.argv[7]) + satellite + '//' + storage + '//' + 'GCM_' + product[2:6] + 'DA_' + start + '.tif')
