...
if (inside == True):
    ...
    date = Start[0:12]
    grid = driver.Create((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date, ncols, nlines, 1, data_type)#, options)
    ...
    dst_ds = driver.CreateCopy((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date + '.tif', grid, 0) 
    ...
    grid = None
    # Delete the grid
    os.remove((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band  + '_' + date)     
    #print("Processing finished.")

    date_day = date[0:8] # this option takes lots of disk space! But it is possible
	
    # Create the mosaic ===========================================================
    gdal.BuildVRT((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt', sorted(glob.glob((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + '_' + date_day +'*.tif'), key=os.path.getmtime), srcNodata = -10)
    gdal.Translate((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band[0:4] + 'HA_' + date + '.tif', (sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt')
    print('Generated GeoTIFF: ', 'JPS_' + band[0:4] + 'HA_' + date + '.tif')
    os.remove((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band + 'HA_' + date + '.vrt')
    # Export the result to GeoTIFF ================================================
    ...
    mosaic = gdal.Open((sys.argv[7]) + satellite + '//' + product + '//' + 'JPS_' + band[0:4] + 'HA_' + date + '.tif')
