...
if ('d6.gif' in path):
    ...
    # Convert to webp
    im = Image.open(out_dir + 'IDK_SAM004_SEC.gif')
    im.save(out_dir + 'IDK_SAM004_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_SAM005_SEC.gif')
    im.save(out_dir + 'IDK_SAM005_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_SAM006_SEC.gif')
    im.save(out_dir + 'IDK_SAM006_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_1.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_1.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_2.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_2.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_3.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_3.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_4.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_4.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_5.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_5.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_SAMQPF_SEC_6.gif')
    im.save(out_dir_html + 'IDK_SAMQPF_SEC_6.webp', format = "WebP", lossless = True)
    im.close()
    ...
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_SAM004_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_SAM004_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_SAM005_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_SAM005_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_SAM006_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_SAM006_SEC_quicklook.webp', format = "WebP", lossless = True)   
    im.close()
    
    os.remove(out_dir + 'IDK_SAM001_SEC.gif') 
    os.remove(out_dir + 'IDK_SAM002_SEC.gif')        
    os.remove(out_dir + 'IDK_SAM003_SEC.gif')
    os.remove(out_dir + 'IDK_SAM004_SEC.gif')
    os.remove(out_dir + 'IDK_SAM005_SEC.gif')
    os.remove(out_dir + 'IDK_SAM006_SEC.gif')
    ...
    os.remove(out_dir_html + 'IDK_SAMQPF_SEC_4.gif')
    os.remove(out_dir_html + 'IDK_SAMQPF_SEC_5.gif')
    os.remove(out_dir_html + 'IDK_SAMQPF_SEC_6.gif')
    ...
    os.remove(out_dir_quicklooks + 'IDK_SAM004_SEC_quicklook.png')
    os.remove(out_dir_quicklooks + 'IDK_SAM005_SEC_quicklook.png')
    os.remove(out_dir_quicklooks + 'IDK_SAM006_SEC_quicklook.png')
    ...
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRC001_SEC.gif')
    im.save(out_dir + 'IDK_CRC001_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRC002_SEC.gif')
    im.save(out_dir + 'IDK_CRC002_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRC003_SEC.gif')
    im.save(out_dir + 'IDK_CRC003_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CRCQPF_SEC_1.gif')
    im.save(out_dir_html + 'IDK_CRCQPF_SEC_1.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CRCQPF_SEC_2.gif')
    im.save(out_dir_html + 'IDK_CRCQPF_SEC_2.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CRCQPF_SEC_3.gif')
    im.save(out_dir_html + 'IDK_CRCQPF_SEC_3.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRC01C_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRC01C_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRC02C_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRC02C_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRC03C_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRC03C_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    os.remove(out_dir + 'IDK_CRC001_SEC.gif') 
    os.remove(out_dir + 'IDK_CRC002_SEC.gif')        
    os.remove(out_dir + 'IDK_CRC003_SEC.gif')

    os.remove(out_dir_html + 'IDK_CRCQPF_SEC_1.gif')
    os.remove(out_dir_html + 'IDK_CRCQPF_SEC_2.gif')   
    os.remove(out_dir_html + 'IDK_CRCQPF_SEC_3.gif')

    os.remove(out_dir_quicklooks + 'IDK_CRC01C_SEC_quicklook.png')
    os.remove(out_dir_quicklooks + 'IDK_CRC02C_SEC_quicklook.png')    
    os.remove(out_dir_quicklooks + 'IDK_CRC03C_SEC_quicklook.png')
    ...
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRE001_SEC.gif')
    im.save(out_dir + 'IDK_CRE001_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRE002_SEC.gif')
    im.save(out_dir + 'IDK_CRE002_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir + 'IDK_CRE003_SEC.gif')
    im.save(out_dir + 'IDK_CRE003_SEC.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CREQPF_SEC_1.gif')
    im.save(out_dir_html + 'IDK_CREQPF_SEC_1.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CREQPF_SEC_2.gif')
    im.save(out_dir_html + 'IDK_CREQPF_SEC_2.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_html + 'IDK_CREQPF_SEC_3.gif')
    im.save(out_dir_html + 'IDK_CREQPF_SEC_3.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRE01E_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRE01E_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRE02E_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRE02E_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    # Convert to webp
    im = Image.open(out_dir_quicklooks + 'IDK_CRE03E_SEC_quicklook.png')
    im.save(out_dir_quicklooks + 'IDK_CRE03E_SEC_quicklook.webp', format = "WebP", lossless = True)
    im.close()
    
    os.remove(out_dir + 'IDK_CRE001_SEC.gif') 
    os.remove(out_dir + 'IDK_CRE002_SEC.gif')        
    os.remove(out_dir + 'IDK_CRE003_SEC.gif')

    os.remove(out_dir_html + 'IDK_CREQPF_SEC_1.gif')
    os.remove(out_dir_html + 'IDK_CREQPF_SEC_2.gif')   
    os.remove(out_dir_html + 'IDK_CREQPF_SEC_3.gif')

    os.remove(out_dir_quicklooks + 'IDK_CRE01E_SEC_quicklook.png')
    os.remove(out_dir_quicklooks + 'IDK_CRE02E_SEC_quicklook.png')    
    os.remove(out_dir_quicklooks + 'IDK_CRE03E_SEC_quicklook.png')
