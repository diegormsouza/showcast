...
# Configuration 
colors = ["#a3a3a3", "#debd6c", "#c39c3f", "#ffff52", "#dee69a", "#d4ffd2", "#a8ffab", "#90fe8f", "#6dfe6e", "#51ff4f", "#29fe29", "#0aff0d", "#03f402", "#01ed00", "#01e201", "#01d901", "#02cb00", "#01b700", "#009f00", "#037e00", "#026002", "#024c00", "#013a00", "#012500", "#001200"]
cmap = matplotlib.colors.ListedColormap(colors)
cmap.set_over('#001200')
cmap.set_under('#a3a3a3')
vmin = 0.0
vmax = 1.0
...
"title_text": prod_title + " ", "title_size": int(sizex * 0.0025), "title_x_offset": int(sizex * 0.01), "title_y_offset": sizey - int(sizey * 0.016),
