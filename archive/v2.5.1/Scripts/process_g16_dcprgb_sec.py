...
if osystem == "Windows":
    path_ch02 = re.sub('Band13\\\\OR_ABI-L2-CMIPF*(.*)', '', path_ch13)
else:
    path_ch02 = re.sub('Band13/OR_ABI-L2-CMIPF*(.*)', '', path_ch13)
...
osystem = platform.system()
if osystem == "Windows":
    path_ch05 = re.sub('Band13\\\\OR_ABI-L2-CMIPF*(.*)', '', path_ch13)
else:
    path_ch05 = re.sub('Band13/OR_ABI-L2-CMIPF*(.*)', '', path_ch13)
...
"title_text": "GOES-" + satellite[1:3] + " DCP RGB ", "title_size": int(data_ch13.shape[1] * 0.005), "title_x_offset": int(data_ch13.shape[1] * 0.01), "title_y_offset": data_ch13.shape[0] - int(data_ch13.shape[0] * 0.016), 
