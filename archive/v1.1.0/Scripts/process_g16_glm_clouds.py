...
"title_text": "GOES-16 GLM + BAND-13", "title_size": int(data.shape[1] * 0.005), "title_x_offset": int(data.shape[1] * 0.01), "title_y_offset": data.shape[1] - int(data.shape[1] * 0.016), 
...
img1 = ax.pcolormesh(lons_file, lats_file, mout1, shading='None', vmin=0, vmax=4, alpha=0.4, cmap='BuPu_r', transform=ccrs.PlateCarree(), zorder=9)
img2 = ax.pcolormesh(lons_file, lats_file, mout2, shading='None', vmin=0, vmax=4, alpha=0.6, cmap='BuPu_r', transform=ccrs.PlateCarree(), zorder=10)
img3 = ax.pcolormesh(lons_file, lats_file, mout3, shading='None', vmin=0, vmax=50, alpha=0.8, cmap='Blues_r', transform=ccrs.PlateCarree(), zorder=11)
img4 = ax.pcolormesh(lons_file, lats_file, groups, shading='None',vmin=0, vmax=5000, alpha=0.4, cmap='binary', transform=ccrs.PlateCarree(), zorder=12)
