...
for x in range(1, 7):
    ...
    # Make the barb plot  
    ax.barbs(lons, lats, u_comp, v_comp, length = 2.50, sizes = dict(emptybarb=0.125, spacing=0.1, height=0.250), linewidth=0.5, pivot='middle', barbcolor=color, transform=ccrs.PlateCarree(), zorder=11)
