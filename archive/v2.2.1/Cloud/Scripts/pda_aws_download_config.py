...
BUCKETS = ['noaa-goes16'] # Choose from ['noaa-goes16', 'noaa-goes17'] or both
...
ABI_L2_CMIPF_Channel = ['C01', 'C03', 'C04', 'C05', 'C06', 'C07', 'C08', 'C09', 'C10', 'C11', 'C12', 'C13', 'C14', 'C15', 'C16']
...
JULIAN_DAY = str(datetime.datetime.now().timetuple().tm_yday).zfill(3) # Julian day got from local machine
...
if (int(HOUR) > 23):
	...
	JULIAN_DAY = str(int(JULIAN_DAY) + 1).zfill(3)
					...
					if files[-1] not in log:
						...
						if matches == 0: # If there are no matches
							...
							if osystem == "Windows": 
								...
								os.system(main_dir + '//Cloud//Apps//' + 'rclone' + extension + " " + 'copy publicAWS:' + BUCKET + "/" + PRODUCT + "/" + YEAR + "/" + JULIAN_DAY + "/" + HOUR + "/" + files[-1] + " " + OUTDIR)
							else:
								...
								os.system(main_dir + '//Cloud//Apps//' + 'rclone' + extension + " " + 'copy publicAWS:' + BUCKET + "/" + PRODUCT + "/" + YEAR + "/" + JULIAN_DAY + "/" + HOUR + "/" + files[-1] + " " + OUTDIR  + " --config " + main_dir + '//Cloud//Apps//' + 'rclone.conf')
							print ("")
