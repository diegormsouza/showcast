...
# Image path
path = (sys.argv[1])
#path = ("..//Samples//OR_ABI-L2-FDCF-M6_G16_s20192961740359_e20192961750067_c20192961750296.nc")
...
X = file.variables['x'][:][::f] * sat_h
Y = file.variables['y'][:][::f] * sat_h
...
# Plot the image
img = ax.scatter(lons, lats, s = 150, c=data2, cmap=plot_config["cmap"], transform=ccrs.PlateCarree(), edgecolors='black', zorder=3)
'''
...
my_legend = plt.imread(main_dir + '//Legends//FIRE_legend.png')
