...
data = file.variables['Rad'][:,:][::f ,::f ]

if int(band) <= 6:
	kappa = file.variables['kappa0'][:]
	data = kappa*data
else:
	planck_fk1 = file.variables['planck_fk1'][:]
	planck_fk2 = file.variables['planck_fk2'][:]
	planck_bc1 = file.variables['planck_bc1'][:]
	planck_bc2 = file.variables['planck_bc2'][:]
