...
"dpi": 150, 
"states_color": 'white', "states_width": data_ch13.shape[0] * 0.00006, 
...
"title_text": "GOES-" + satellite[1:3] + " ASG RGB ", "title_size": int(data_ch13.shape[1] * 0.005), "title_x_offset": int(data_ch13.shape[1] * 0.01), "title_y_offset": data_ch13.shape[0] - int(data_ch13.shape[0] * 0.016), 
